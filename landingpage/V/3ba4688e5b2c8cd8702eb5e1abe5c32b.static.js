...
window.lang_locale = 'ru';
window.mounths_locale = 'ru';
months_localized = {
...
var VideoSrc ='http://cdn.ahacdu.com/'

$('document').ready(function () {
	$('video.avid').each(function(){
	if($(this).data('url')){
	$(this).html('<source src="' + VideoSrc + $(this).data('url') + '.mp4"><source src="' + VideoSrc + $(this).data('url') + '.webm">');
	}
});
});
